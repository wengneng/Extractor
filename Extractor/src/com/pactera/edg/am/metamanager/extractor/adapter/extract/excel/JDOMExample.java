...
public class JDOMExample {
    ...
    public static void main(String argv[])
    	...
    	//transform("E:\\workspace\\MM_my\\xslt\\web\\cognos.xml", "E:\\workspace\\MM_my\\xslt\\web\\cognos.xsl");
    	transform("E:\\workspace\\MM_my\\xslt\\test08.xml", "E:\\workspace\\MM_my\\xslt\\test08.xslt");
    	/*
    	if (argv.length == 2) {
    ...
    public static void transform(String sourceID, String xslID)
        ...
        transformer.transform(docw, new StreamResult(baos));
