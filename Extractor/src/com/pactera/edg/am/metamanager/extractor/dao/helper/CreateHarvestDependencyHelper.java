...
/**
 * 添加待审核元数据依赖关系操作PreparedStatementCallback辅助类
 * 
 * @author user
 * @version 1.0 Date: Oct 5, 2009
 */
public class CreateHarvestDependencyHelper extends CreateDependencyHelper {

	protected String taskInstanceId;

	public CreateHarvestDependencyHelper(int batchSize) {
		super(batchSize);
